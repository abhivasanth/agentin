...
__export(index_exports, {
  HeliconeLogBuilder: () => HeliconeLogBuilder,
  HeliconeManualLogger: () => HeliconeManualLogger,
  HeliconePromptManager: () => HeliconePromptManager
});
...
var PROMPT_PARTIAL_REGEX = /\{\{\s*hcp\s*:\s*([a-zA-Z0-9]{6})\s*:\s*(\d+)\s*(?::\s*([a-zA-Z_-][a-zA-Z0-9_-]*))?\s*\}\}/g;
    ...
    while ((match = PROMPT_PARTIAL_REGEX.exec(template)) !== null) {
      ...
      if (!variables.has(key)) {
        variables.set(key, {
          ...
          environment: environment ? environment.trim() : void 0,
          raw: fullMatch
        });
      }
    }
...
var HeliconePromptManager = class {
  ...
  extractPromptPartials(sourcePromptBody) {
    ...
    const seenPartials = /* @__PURE__ */ new Set();
  ...
  getPromptPartialSubstitutionValue(promptPartial, sourceBody) {
    ...
    if (typeof chosenMessage.content === "string") {
      ...
      return chosenMessage.content.map((contentPart) => {
