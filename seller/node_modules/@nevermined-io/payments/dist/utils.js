...
export const getRandomBigInt = (bits = 128) => {
 ...
 */
export const isStepIdValid = (stepId) => {
 ...
 */
export const getQueryProtocolEndpoints = (serverHost) => {
 ...
 * @returns
 */
export const getAIHubOpenApiUrl = (serverHost) => {
    const url = new URL(serverHost);
...
export const generateDeterministicAgentId = (agentId, className) => {
    if (!className)
        return agentId;
...
export const logSessionInfo = (agentId, sessionId, agentName = 'SceneTechnicalExtractor') => {
