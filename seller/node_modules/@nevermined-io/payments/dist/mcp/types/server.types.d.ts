 ...
 */
export type ToolHandler<TArgs = any, TResult = any> = (args: TArgs, context?: ToolContext) => Promise<TResult> | TResult;
/**
 * Handler function for a resource.
 */
export type ResourceHandler<TResult = any> = (uri: URL, variables: Record<string, string | string[]>, context?: ResourceContext) => Promise<TResult> | TResult;
/**
 * Handler function for a prompt.
 */
export type PromptHandler<TResult = any> = (args: Record<string, string>, context?: PromptContext) => Promise<TResult> | TResult;
/**
