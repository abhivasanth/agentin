 ...
 */
export function buildLogicalToolUrl(serverName, toolName, args) {
    let query = '';
    try {
 ...
 */
export function buildLogicalResourceUrl(serverName, resourceName, variables) {
    let query = '';
    try {
        const params = new URLSearchParams();
 ...
 */
export function buildLogicalMetaUrl(serverName, method) {
...
export function buildLogicalUrl(options) {
    ...
    if (kind === 'resource')
        return buildLogicalResourceUrl(serverName, name, argsOrVars || {});
    // tools and prompts use tool URL shape
    return buildLogicalToolUrl(serverName, name, argsOrVars);
}
//# sourceMappingURL=logical-url.js.map