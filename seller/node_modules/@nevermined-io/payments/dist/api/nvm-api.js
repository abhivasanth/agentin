...
export class AbstractHTTPClient {
    ...
    parseUrl(urlRequested, reqOptions) {
        let _host;
    ...
    parseHeaders(requestHeaders, accessToken) {
        return {
    ...
    //   }
    // }
    async request(method, url, data, reqOptions = {
        ...
        try {
            ...
            if (axios.isAxiosError(err) && err.response) {
                throw new Error(`HTTP ${err.response.status}: ${err.response.data?.message || 'Request failed'}`);
            }
...
//# sourceMappingURL=nvm-api.js.map