export function getDefaultHeliconeHeaders(heliconeApiKey, accountAddress, environmentName, agentRequest, customProperties) {
 ...
 */
export function createHeliconePayload(config) {
    return {
        model: config.model,
 ...
 */
export function createHeliconeResponse(config) {
