import { Address, NvmAPIResult, PaginationOptions, PaymentOptions, PlanBalance, PlanCreditsConfig, PlanRedemptionType, PlanMetadata, PlanPriceConfig, StripeCheckoutResult } from '../common/types.js';
 ...
 */
export declare class PlansAPI extends BasePaymentsAPI {
     ...
     */
    getFiatPriceConfig(amount: bigint, receiver: Address): PlanPriceConfig;
    /**
     * Builds a Pay-As-You-Go price configuration using the template address from the API.
     */
    getPayAsYouGoPriceConfig(amount: bigint, receiver: Address, tokenAddress?: Address): Promise<PlanPriceConfig>;
    /**
     * Builds a Pay-As-You-Go credits configuration.
     */
    getPayAsYouGoCreditsConfig(): PlanCreditsConfig;
    /**
     ...
     */
    getCryptoPriceConfig(amount: bigint, receiver: Address, tokenAddress?: Address): PlanPriceConfig;
    /**
     ...
     */
    getERC20PriceConfig(amount: bigint, tokenAddress: Address, receiver: Address): PlanPriceConfig;
    /**
     * Builds a FREE price configuration (no payment required).
     * @returns The PlanPriceConfig representing a free plan.
     */
    getFreePriceConfig(): PlanPriceConfig;
    /**
     ...
     */
    getNativeTokenPriceConfig(amount: bigint, receiver: Address): PlanPriceConfig;
    /** Credits helpers */
    /**
     ...
     */
    getExpirableDurationConfig(durationOfPlan: bigint): PlanCreditsConfig;
    /**
     ...
     */
    getNonExpirableDurationConfig(): PlanCreditsConfig;
    /**
     ...
     */
    getFixedCreditsConfig(creditsGranted: bigint, creditsPerRequest?: bigint): PlanCreditsConfig;
    /**
     ...
     */
    getDynamicCreditsConfig(creditsGranted: bigint, minCreditsPerRequest?: bigint, maxCreditsPerRequest?: bigint): PlanCreditsConfig;
    /**
     ...
     */
    getPlans(page?: number, offset?: number, sortBy?: string, sortOrder?: string): Promise<any>;
    /**
     ...
     * ```
     */
    getAgentsAssociatedToAPlan(planId: string, pagination?: PaginationOptions): Promise<any>;
    /**
     ...
     *
     */
    getPlanBalance(planId: string, accountAddress?: Address): Promise<PlanBalance>;
    /**
     ...
     * ```
     */
    orderPlan(planId: string): Promise<NvmAPIResult>;
    /**
     ...
     * ```
     */
    orderFiatPlan(planId: string): Promise<{
     ...
     * ```
     */
    mintPlanCredits(planId: string, creditsAmount: bigint, creditsReceiver: Address): Promise<NvmAPIResult>;
    /**
