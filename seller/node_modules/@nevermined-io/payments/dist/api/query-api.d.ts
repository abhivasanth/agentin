 ...
 */
export declare class AIQueryApi extends AbstractHTTPClient {
    /**
     ...
     */
    send(accessCredentials: AgentAccessCredentials, method: 'GET' | 'POST' | 'PUT' | 'DELETE' | 'PATCH', url: string, data?: any, reqOptions?: HTTPRequestOptions): Promise<import("axios").AxiosResponse<any, any, {}>>;
}
