...
export class OrganizationsAPI extends BasePaymentsAPI {
     ...
     */
    async createMember(userId, userEmail, userRole) {
        const body = {
     ...
     */
    async getMembers(role, isActive, page = 1, offset = 100) {
        const body = {
            role,
            isActive,
            page,
     ...
     */
    async connectStripeAccount(userEmail, userCountryCode, returnUrl) {
        const body = {
            userEmail,
            userCountryCode,
            returnUrl,
