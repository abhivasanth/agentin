 ...
 * ```
 */
export declare function buildPaymentRequired(planId: string, options?: {
    endpoint?: string;
    agentId?: string;
    httpVerb?: string;
    network?: string;
 ...
 */
export declare class FacilitatorAPI extends BasePaymentsAPI {
    /**
...
//# sourceMappingURL=facilitator-api.d.ts.map