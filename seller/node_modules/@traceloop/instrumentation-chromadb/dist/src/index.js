...
class ChromaDBInstrumentation extends instrumentation.InstrumentationBase {
    constructor(config = {}) {
    ...
    init() {
        const module = new instrumentation.InstrumentationNodeModuleDefinition("chromadb", ["^1.8.1"], this.wrap.bind(this), this.unwrap.bind(this));
        return module;
    }
...
exports.ChromaDBInstrumentation = ChromaDBInstrumentation;
